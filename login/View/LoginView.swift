...
struct LoginView: View {
    @State private var username = "TheEdvorian"
    ...
    var body: some View {
        ...
        VStack(alignment: .center, spacing: 16) {
            ...
            CustomTextField(icon: "person.fill", title: "Username", hint: "Login Name", value: $username, showPassword: .constant(false))
             
            CustomTextField(icon: "key.fill", title: "Password", hint: "Login Credentials", value: $password, showPassword: $showPassword).padding(.vertical)
            
            CustomTextField(icon: "at", title: "Email address", hint: "Email", value: $email, showPassword: .constant(false))
